...
class SavedPaymentDetails extends StatefulWidget {
  const SavedPaymentDetails({super.key});

  @override
  State<SavedPaymentDetails> createState() => _SavedPaymentDetailsState();
}

class _SavedPaymentDetailsState extends State<SavedPaymentDetails> {
  @override
